...
main(int argc, char* argv[])
{
  ...
  producerHelper.SetAttribute("Frequency", StringValue("50")); // One packet every 0.02 Seconds
  producerHelper.SetPrefix("/prefix");
  producerHelper.SetAttribute("PayloadSize", StringValue("1000")); // 64kbps * 0.02sec + 58byte Packet-Overhead
  ...
  pushParticipants.Add(nodes.Get(2));

  ns3::ndn::PushTracer::Install(pushParticipants, std::string("./results/PushData_trace.txt"));
