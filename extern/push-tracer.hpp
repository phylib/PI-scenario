...
#ifndef PUSH_TRACER_H
#define PUSH_TRACER_H
 ...
 */
class PushTracer : public L3Tracer {
public:
  /**
   ...
   */
  PushTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  PushTracer(shared_ptr<std::ostream> os, const std::string& node);
